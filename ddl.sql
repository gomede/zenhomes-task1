...
INSERT INTO `ZENHOMES`.`APARTMENT` (`ID`, `NUMBER`, `PRICE`, `BUILDING_FK`) VALUES (1, 1, 1000, 1);
INSERT INTO `ZENHOMES`.`APARTMENT` (`ID`, `NUMBER`, `PRICE`, `BUILDING_FK`) VALUES (2, 2, 2000, 1);
